...
const tabsData = [
  { id: "tab1", title: "Tab1", content: "This is a content for Tab1" },
  { id: "tab2", title: "Tab2", content: "This is a content for Tab2" },
  { id: "tab3", title: "Tab3", content: "This is a content for Tab3" },
];
  ...
  function renderTab() {
    ...
    tabContainer.addEventListener("click", function (event) {
      if (event.target.matches(".tabLinks")) {
        const tabsId = event.target.getAttribute("data-tab");
